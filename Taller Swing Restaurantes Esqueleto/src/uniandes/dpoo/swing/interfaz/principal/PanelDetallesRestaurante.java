...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    public PanelDetallesRestaurante()
    {
        ...
        JLabel lblNombreTexto = new JLabel("Nombre:");
        labNombre = new JLabel("Sin asignar");
        add(lblNombreTexto);
        add(labNombre);

        // Configura la etiqueta para la calificación
        JLabel lblCalificacionTexto = new JLabel("Calificación:");
        labCalificacion = new JLabel(new ImageIcon("./imagenes/stars1.png")); // Imagen por defecto
        add(lblCalificacionTexto);
        add(labCalificacion);

        // Configura el checkbox para indicar si ya se visitó o no el restaurante
        JLabel lblVisitadoTexto = new JLabel("Visitado:");
        chkVisitado = new JCheckBox();
        chkVisitado.setEnabled(false); // No editable por el usuario
        add(lblVisitadoTexto);
        add(chkVisitado);
    }
     ...
     * @param visitado Indica si el restaurante fue visitado
     */
